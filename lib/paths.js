 ...
 *
 * Key features:
 * - Resolves project-local resources from `AGENT_CLI_ROOT` when set, otherwise from the current working directory.
...
export const SKILLS_ROOT = path.join(AGENT_WORLD_ROOT, 'skills');
